...
<!-- 附加js -->
    <#include  "commons_js.ftl"/>
    <#include  "commons_css.ftl"/>
...
<#include "/admin/app/createUserRule_mower.ftl" />
<#include "/admin/app/findCourse_mower.ftl" />
<#include "/admin/app/findGroup_mower.ftl" />
<#include "/admin/app/findUserRank_mower.ftl" />
<#include "/admin/app/findUser_mower.ftl" />
<#include "/admin/app/findUserForSignUp_mower.ftl" />
<#include "/admin/app/findUserRule_mower.ftl" />
<#include "/admin/app/findUserRuleForCategory_mower.ftl" />
<#include "/admin/app/messageImgList_mower.ftl" />
